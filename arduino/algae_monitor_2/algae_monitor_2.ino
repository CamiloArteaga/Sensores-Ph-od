// algae_monitor_2.ino
// Arduino 2: pH (DFRobot electrode + DFRobot board) + Dissolved Oxygen
// A0 = pH sensor (DFRobot electrode)
...
#define PH_PIN A0
#define DO_PIN A1
#define DEVICE_ID "pH_DO_2"  // Arduino 2: DFRobot electrode + DO sensor
